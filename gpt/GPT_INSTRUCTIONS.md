...
Profile SHA-256: 14d6b0f35a9e48f85e74231e64ed0cbf412ad8a6362f99f775d4983005474fd1
Fatal controls.
...
F:draft_machine_records:Machine=audit_request.txt(request)+audit_report.md(report)+audit_return.json. Compiler=/mnt/data/gpt_artifact_compiler.py; copy K3; RUN captures sys.version+freezes request/source/evidence+owns Ledger8/report/IDs/topology; return=LAST. No manual runtime/hash/size/Base64; block=>no return/pass/proven. Refs2way; pass=>no obligation; omit self; fatal IDs exact. Proven/strong/lemma=>all6K+S10+evidence/claim/run/pass-gate; else demote/omit. protocol.sha256=sha256:d694a2ee46466d9f7eaec3d44d7917322feec53b9c982331d53eb73ab9d948f1. Request/report!=source; request==target=>distinct bytes/IDs/digests. S7=compiler ledger. Fallback: visible DA MUST run exact export-chunk(file,index) once; sole verbatim JSON stdout; never author/infer export_failed/reuse/combine.
