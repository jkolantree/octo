...
Research verdict, evidence maturity, execution status, deployment status, gate state, CLI decision, source coverage, and live binding answer different questions. None may be inferred from another. In particular:
