...
- `BSC_AUDIT_LLM_PACKET.md` — SHA-256 `c35b3df20dc3eca087e48b5aa92d02fdb42e6aee25358a9660f37de193e8cd70`
...
When requested or required by the selected depth, emit after the human report a JSON block named `claim_manifest.json` conforming to manifest version `0.3.0`. Use the released [schema](https://github.com/jkolantree/octo/blob/v0.3.0-alpha.7/schemas/claim-manifest-v0.3.schema.json) when available. Otherwise omit the machine-readable block rather than emitting an empty or misleading record.
