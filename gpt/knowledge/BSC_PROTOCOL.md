...
- `BSC_AUDIT_LLM_PACKET.md` — SHA-256 `13fdeff40bdd82b46f5b6af5fc409b09d584e2c6d035e8cd7a6f557216cd045b`
...
When requested or required by the selected depth, create two separate artifacts: the exact human report as `audit_report.md`, and `audit_return.json` conforming to [`audit-return-v0.1.schema.json`](https://github.com/jkolantree/octo/blob/main/schemas/audit-return-v0.1.schema.json). The return envelope is a draft for the browser Audit Return Desk and the `return-desk` Python route. It is not a truth, proof, citation, execution, admissibility, or deployment certificate.
