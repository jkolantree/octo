...
- `BSC_AUDIT_LLM_PACKET.md` — SHA-256 `d694a2ee46466d9f7eaec3d44d7917322feec53b9c982331d53eb73ab9d948f1`
...
When requested or required by the selected depth, create two separate artifacts: the exact human report as `audit_report.md`, and `audit_return.json` conforming to [`audit-return-v0.1.schema.json`](https://github.com/jkolantree/octo/blob/v0.3.0-alpha.8/schemas/audit-return-v0.1.schema.json). The return envelope is a draft for the browser Audit Return Desk and the `return-desk` Python route. It is not a truth, proof, citation, execution, admissibility, or deployment certificate.
