...
4. Upload these Knowledge files in this exact order:
   ...
   3. `BSC_SUPPORTED_CHECKS.md` — 38870 bytes — SHA-256 `80c761d867f81f7315eaaa418ef6efa5787b3aadd1c1fb1bf512d59e0a4364be` — Implemented Python routes, schemas, findings, and limitations
   4. `BSC_WORKED_EXAMPLES.md` — 6892 bytes — SHA-256 `e67812c6e368758d67a277c8223af23e1aec5cd5d60babfd8f4593d4467aa1e8` — Known-answer and adversarial examples without redefining the protocol
