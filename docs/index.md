...
The static [Pages module](../pages/README.md) is the accessible front door to that same canonical packet. Alpha.11 retains the Audit Return Desk introduced in alpha.8. Its committed protocol, return schema, and checksum metadata are mechanically generated and checked for drift.
