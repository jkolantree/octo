...
Observed alpha.10 release, live Update, and post-save verification on 2026-07-28, followed by the alpha.19 repository version line. Its tag target and GitHub release state are external observations; its generated package is separately classified as an unvalidated future live-GPT update candidate:
...
| Alpha.19 repository source and package | **versioned source; generated package unvalidated for future live update and not installed live** | The candidate preserves the alpha.18 renderer-safe mathematics and adds a closed finite-census replay for one exact conditional observational bound. It does not establish its four external premise identities, causal truth, unsampled generalization, independent replication, or deployment permission. This source row alone does not establish tag or GitHub release publication. No owner-editor Update or alpha.19 Preview claim is part of this lane |
...
## Alpha.8 through alpha.19 boundary
