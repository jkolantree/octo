...
Observed alpha.10 release, live Update, and post-save verification on 2026-07-28, followed by the alpha.16 typed-coherence engine candidate:
...
| Alpha.16 repository package | **unvalidated candidate; not installed live** | The regenerated package documents strict certificate variants, authority-typed judgments, execution-derived release receipts, and host-independent release ordering. No owner-editor Update or alpha.16 Preview claim is part of this lane |
...
| Repository release line | **v0.3.0-alpha.16** | The exact commit, tree, tag, semantically typed assets, and keyless attestations are bound by the corrected tag workflow. The byte-identical public protocol remains component version `0.3.0-alpha.13`; no prior tag is moved or relabeled |
