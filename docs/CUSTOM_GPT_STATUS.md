...
Observed alpha.10 release, live Update, and post-save verification on 2026-07-28, followed by the alpha.17 repository version line. Its tag target and GitHub release state are external observations; its generated package is separately classified as an unvalidated future live-GPT update candidate:
...
| Alpha.17 repository source and package | **versioned source; generated package unvalidated for future live update and not installed live** | The candidate corrects mathematical rendering, documentation status, source projection, and documentation lint without changing engine algorithms or schemas. This source row alone does not establish tag or GitHub release publication. No owner-editor Update or alpha.17 Preview claim is part of this lane |
...
| Repository version line | **v0.3.0-alpha.17; publication must be verified externally** | The tag target, GitHub release, assets, and keyless attestations are separate service records and must be checked after promotion. The byte-identical public protocol remains component version `0.3.0-alpha.13`; no prior tag is moved or relabeled |
| Prior GitHub prerelease | **preserved historical release** | [`v0.3.0-alpha.16`](https://github.com/jkolantree/octo/releases/tag/v0.3.0-alpha.16) remains at commit `9798d51c443eb104318ce402fd27adb7958f5352`, tree `356a65804a2af18664f3d7ca67f2588514c9779c` |
...
## Alpha.8 through alpha.17 boundary
