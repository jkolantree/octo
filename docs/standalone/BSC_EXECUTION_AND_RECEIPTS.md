...
Sensitive vulnerability reports follow [SECURITY.md](https://github.com/jkolantree/octo/blob/v0.3.0-alpha.11/SECURITY.md). Scientific false-pass and false-block reports that contain no sensitive information may use the issue forms.
