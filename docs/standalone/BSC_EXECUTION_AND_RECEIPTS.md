...
**Generation:** frozen deterministic repository derivative from the final artifact-capable candidate
...
- `docs/THREAT_MODEL.md` — SHA-256 `1936750d1dd9ca4540d95351c9a9da7fa566e2c2802e9cc672a7fb38c411acc7`
- `docs/PROOF_CARRYING_ADAPTERS.md` — SHA-256 `b8ad039964660b704a1076348c834af9201c9463e7d6ca1fabcec91c3213212c`
- `scripts/gpt_artifact_compiler.py` — SHA-256 `97cdbe7bf944eb942aa994138b94c8b334b91555e820904e57023dc09558fd2b`

Source hashes bind the repository bytes represented by this frozen derivative. This file is not uploaded to the compact public GPT and does not prove that any compiler or external tool ran.
...
1. The official-service URL and its timestamped availability record are maintained in [CUSTOM_GPT_STATUS.md](https://github.com/jkolantree/octo/blob/v0.3.0-alpha.13/docs/CUSTOM_GPT_STATUS.md). A repository package is reproducible source and an update candidate, not evidence that its exact bytes are installed, bound to the saved editor, or Preview-validated. Indexed Knowledge bytes are `NON_ADMISSIBLE_UNHASHABLE` and cannot support engine gates. Uploads are processed through ChatGPT under the user's applicable settings and terms. The official configuration contains no Action, hosted API, account, analytics, or cloud storage.
...
Sensitive vulnerability reports follow [SECURITY.md](https://github.com/jkolantree/octo/blob/v0.3.0-alpha.13/SECURITY.md). Scientific false-pass and false-block reports that contain no sensitive information may use the issue forms.
