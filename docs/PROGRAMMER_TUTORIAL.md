...
The current public prerelease is `v0.3.0-alpha.10`. The `holonomy` route first appeared in alpha.3. Preserve the exact engine version with every output.
...
The claim-manifest contract is [schemas/claim-manifest-v0.3.schema.json](../schemas/claim-manifest-v0.3.schema.json). The separate returned-audit contract is [schemas/audit-return-v0.1.schema.json](../schemas/audit-return-v0.1.schema.json). Their schema versions are independent of the release candidate's PEP 440 version `0.3.0a10`.
