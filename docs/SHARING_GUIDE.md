...
The v0.3.0-alpha.20 source line is a research preview. Its publication state
...
## v0.3.0-alpha.20 release contents

When present, the annotated `v0.3.0-alpha.20` tag under the project's
...
- `BSC_CUSTOM_GPT_PACKAGE_0.3.0-alpha.20.zip`, the deterministic Custom GPT editor, Knowledge, evaluation, manifest, and checksum package;
- `bsc-audit-engine-0.3.0-alpha.20.zip`, the versioned tracked-source archive;
...
```text
https://github.com/jkolantree/octo/releases/tag/v0.3.0-alpha.20
https://raw.githubusercontent.com/jkolantree/octo/v0.3.0-alpha.20/BSC_AUDIT_LLM_PACKET.md
...
validation from source wording or a ZIP alone. The alpha.20 generated package
...
gh attestation verify PATH/TO/ASSET \
  ...
  --source-ref refs/tags/v0.3.0-alpha.20
```
...
The Audit Return Desk was introduced in alpha.8 and remains in alpha.20, under the independently versioned alpha.13 protocol component, for non-admissive inspection of returned output and receipts. Its presence in a Pages or GPT interface does not turn a returned draft into admissible evidence.
