...
static [Pages module](../../pages/README.md) は同じ canonical packet への accessible front door です。alpha.8 development source は Audit Return Desk も含み、committed protocol、return schema、checksum metadata は mechanically generated and checked for drift です。
