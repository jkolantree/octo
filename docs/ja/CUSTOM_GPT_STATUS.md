...
2026-07-28 に alpha.10 release/live Update/post-save verification を observe し、その後 alpha.14 engine-mathematics candidate を作成:
...
| Alpha.14 repository package | **unvalidated candidate; live 未導入** | regenerated package は exact mapping-complex、replay-only evidence firewall、component-contract work を document する。この lane では owner-editor Update も alpha.14 Preview claim も行わない |
...
| Repository release line | **v0.3.0-alpha.14** | exact commit、tree、tag、assets、keyless attestations は new tag workflow に bind される。byte-identical public protocol は component version `0.3.0-alpha.13` のままで、prior tag を move/relabel しない |
