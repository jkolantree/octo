...
| `census_affine_bound.json` | `census` | `no_blocking_findings` | 0 | Every synthetic rational enclosure clears the affine bound with the frozen guard band; premise hashes remain unresolved external obligations. |
